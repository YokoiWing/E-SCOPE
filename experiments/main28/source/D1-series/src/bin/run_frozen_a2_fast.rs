...
mod tests {
    ...
    fn add2_circuit() -> Circuit {
        Circuit::parse(
            Path::new("../mac_egg/test/add2_map_abc.v"),
            Path::new("../mac_egg/test/asap7sc6t_SELECT_LVT_TT_nldm.lib"),
            Path::new("../mac_egg/test/6t_scale_rules.json"),
        )
        .unwrap()
    }
    ...
    fn phase_ii_scale_database_retains_multiple_legal_drives() {
        let database = CellDatabase::load(
            &[PathBuf::from("../mac_egg/test/add2_map_abc.v")],
    ...
    fn static_profile_matches_full_preparation() {
        let input = Path::new("../mac_egg/test/add2_map_abc.v");
        let database = CellDatabase::load(
            &[input.to_path_buf()],
            Path::new("../mac_egg/test/asap7sc6t_SELECT_LVT_TT_nldm.lib"),
            Path::new("../mac_egg/test/6t_scale_rules.json"),
